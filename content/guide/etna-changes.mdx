...
**[ACP-20](https://github.com/avalanche-foundation/ACPs/blob/main/ACPs/20-ed25519-p2p/README.md)**: Adds support for Ed25519 TLS certificates for p2p communications on the Avalanche network.
...
**[ACP-113](https://github.com/avalanche-foundation/ACPs/discussions/112)**: Proposes a mechanism to generate verifiable, non-cryptographic random number seeds on the Avalanche platform.
