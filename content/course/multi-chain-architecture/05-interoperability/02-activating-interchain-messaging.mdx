...
Avalanche offerns native interoperability between all Avalanche L1s. You will be asked if you want to connect your blockchain with other blockchains or the C-Chain. Select the first option to enable your blockchain to interoperate with other blockchains and the C-Chain. You can simply activate it by selecting `Yes`.
