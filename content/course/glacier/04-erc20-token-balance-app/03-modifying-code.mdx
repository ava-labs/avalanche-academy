...
<Step>
First we will implement the `getBlockHeight` function. The goal of this function is to fetch recent blocks from the Glacier Data API then to return the highest block in the first position.
...
<Step>
### Modify `src/app/balance-app/page.tsx`
