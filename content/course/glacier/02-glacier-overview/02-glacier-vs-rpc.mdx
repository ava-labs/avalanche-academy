...
To  get a more comprehensive understanding of the Glacier Data API, you can refer to the [official Glacier Data API documentation](https://developers.avacloud.io/data-api/overview).
...
With the Glacier API, you could simply use a dedicated endpoint such as: 
```bash
GET chains/{chainId}/addresses/{address}/balances:listErc20
``` 
