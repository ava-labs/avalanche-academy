...
The Glacier Data API provides a comprehensive set of endpoints to interact with the Avalanche network. These endpoints allow you to query information about blocks, transactions, assets, and more.

![](/course-images/glacier/glacier-data-api.png)

Below are some of the key endpoints available in the Glacier Data API.
A more comphrensive list of Glacier Data API endpoints can be found [here](https://developers.avacloud.io/data-api/overview).
