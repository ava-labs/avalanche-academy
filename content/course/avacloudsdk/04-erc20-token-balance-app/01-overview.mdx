...
In this section we will use the Data API to create a simple web app that displays a user's ERC-20 token portfolio. This app will allow users to input their Ethereum address and view a list of their ERC-20 token balances.
