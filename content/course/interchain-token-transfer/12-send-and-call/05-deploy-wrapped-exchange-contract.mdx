...
```bash
forge create --rpc-url https://api.avax-test.network/ext/bc/C/rpc --private-key $PK lib/{path}/DexERC20Wrapper.sol:DexERC20Wrapper --constructor-args 0xd00ae08403B9bbb9124bB305C09058E32C39A48c 0xF5c7d9733e5f53abCC1695820c4818C59B457C2C
```
