...
description: Alternative and simplified way to deploy ICTT to transfer ERC20 to ERC20 assets
updated: 2024-05-31
authors: [ashucoder9]
icon: Terminal
---
...
The following example will show you how to send an ERC20 Token on C-chain to an Avalanche L1 as an ERC20 token using Teleporter and Foundry. This demo is conducted on a local network run by the CLI, but can be applied to Fuji Testnet and Avalanche Mainnet directly.
