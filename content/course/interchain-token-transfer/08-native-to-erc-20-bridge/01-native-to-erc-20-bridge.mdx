...
The following code example will show you how to send a Avalanche L1's native token to the C-Chain using Teleporter and Foundry. This demo is conducted on a local network run by the CLI, but can be applied to Fuji Testnet and Avalanche Mainnet directly.
...
| Teleporter Registry           | Avalanche L1  | Address of the TeleporterRegistry contract on Avalanche L1 deployed by the CLI                                                                            |
