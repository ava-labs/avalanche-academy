...
sha256/module.go
This key is later used in the chainConfig to set the activation timestamp of the precompile:
{
  "config": {
    "chainId": 99999,
    // ...
...
We'll see later how we can use this config to do perform more sophisticated actions, like setting the initial state of the precompile.
