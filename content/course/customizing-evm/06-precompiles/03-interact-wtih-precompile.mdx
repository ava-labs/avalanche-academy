...
In this example, we will call the SHA256 precompile to generate hash of the input string. The precompile address is `0x0000000000000000000000000000000000000002`.
