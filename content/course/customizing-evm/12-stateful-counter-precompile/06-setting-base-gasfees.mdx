...
Gas is used for spam prevention. If our precompile is accessible to everyone on our Subnet, it is important to set the gas cost in a way that lets users economically utilize it in their apps, yet prevents spammers from spamming our blockchain with calls to the precompile.
