...
description: Learn how to invoke functions on destionation.
updated: 2024-05-31
...
- **Specify which function to call:** Most smart contracts have multiple functions. We will learn how to specify which function to call and encode different parameters depending on which function is be called
...
- Modify the Calculator to supporter more functions that can be called from the source Avalanche L1
