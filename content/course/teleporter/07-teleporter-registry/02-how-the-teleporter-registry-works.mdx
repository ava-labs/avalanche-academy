...
<img src="/academy/course-images/teleporter/teleporter-registry.png" width="600" class="mx-auto"/>

Internally the TeleporterRegistry maintains a mapping of TeleporterMessenger contract versions to their addresses.

<img src="/academy/course-images/teleporter/teleporter-registry-class-diagram.png" width="400" class="mx-auto"/>
