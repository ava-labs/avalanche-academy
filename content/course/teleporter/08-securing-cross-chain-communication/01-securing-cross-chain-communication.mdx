...
This is where Avalanche Warp Messaging comes into play. It is not EVM specific, but rather a general cross-Subnet communication protocol. In this section you will learn about the underlying cryptographic primitives that make Avalanche Warp Messaging secure.
