...
In this course, you will learn how to build cross-Subnet Solidity dApps with Teleporter and Avalanche Warp Messaging.
...
Cross-chain communication is a crucial building block of multi-chain systems. Utilizing Teleporter and Avalanche Warp Messaging is an incredible easy way to build cross-Subnet dApps, since developers can build on top an extensive and audited development framework. 
...
In this section, we learn what Teleporter is and what is abstracted away from the general dApp developer. You will also build your first cross-Subnet dApps.