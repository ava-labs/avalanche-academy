...
- **originSenderAddress**: The address of the user or contract that called the sendCrossChainMessage function of the Teleporter contract on the origin Avalanche L1
