---
title: 📕 Recap iof Bytes, Encoding and Decoding
description: Learn about the basics of Avalanche.
updated: 2024-05-31
authors: [ashucoder9]
---

When we send a teleporter message, we are just sending a single value of type bytes. This value can contain multiple values of various types (e.g. string, uint & address) using encoding and decoding. 
