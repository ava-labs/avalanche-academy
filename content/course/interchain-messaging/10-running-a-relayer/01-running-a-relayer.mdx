...
As you know now Interchain Messaging requires a running relayer to deliver the warp messages underlying it. So far we just assumed a relayer is running and in fact Avalanche CLI automatically configures and runs a relayer for you if you deploy your Subnet on a local network. However, in a production environment, you will either need to run a relayer yourself or have someone else run it for you.
