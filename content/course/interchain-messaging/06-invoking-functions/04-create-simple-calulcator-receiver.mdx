...
```bash
forge create --rpc-url myblockchain --private-key $PK src/interchain-messaging/2a-invoking-functions/SimpleCalculatorReceiverOnAvalanche L1.sol:SimpleCalculatorReceiverOnAvalanche L1
```
