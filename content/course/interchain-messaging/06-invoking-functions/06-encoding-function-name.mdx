...
```solidity title="src/2b-invoking-functions/CalculatorReceiverOnAvalanche L1.sol"
pragma solidity ^0.8.18;
...
```bash
forge create --rpc-url myblockchain --private-key $PK src/2b-invoking-functions/CalculatorReceiverOnAvalanche L1.sol:CalculatorReceiverOnAvalanche L1
```
