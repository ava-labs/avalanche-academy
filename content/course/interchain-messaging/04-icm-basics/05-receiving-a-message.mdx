...
- **originSenderAddress**: The address of the user or contract that called the sendCrossChainMessage function of the Interchain Messaging contract on the origin Avalanche L1
