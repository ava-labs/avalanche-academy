...
```solidity title="src/interchain-messaging/0a-send-receive/senderOnCChain.sol"
...
```bash
forge create --rpc-url local-c --private-key $PK src/interchain-messaging/0a-send-receive/senderOnCChain.sol:SenderOnCChain
```
