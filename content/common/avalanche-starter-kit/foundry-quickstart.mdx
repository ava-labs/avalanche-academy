...
- **mysubnet:** A Avalanche L1 on your local Avalanche network called mysubnet
- **fuji-c:** The C-Chain of the Fuji Testnet
- **dispatch:** A Avalanche L1 on the Fuji Testnet called Dispatch. It was specifically created for testing Teleporter dApps. 
