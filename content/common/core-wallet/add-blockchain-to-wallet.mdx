...
+-------------------+----------------------------------------------------------------------------------------------------------------------------+
| Codespace         | https://ideal-funicular-g4qxwg9pqxxh9gr4-9650.app.github.dev/ext/bc/mysubnet/rpc                                           | // [!code highlight]
+                   +----------------------------------------------------------------------------------------------------------------------------+
...
Type the name of your Avalanche L1, for example, `mysubnet`.
