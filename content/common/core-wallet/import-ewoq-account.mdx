...
To add the private key to your core wallet, open the core extension and navigate to the account manager.

<Gallery url1="/common-images/core-wallet/go-to-account-manager.png" url2="/common-images/core-wallet/go-to-import-account.png" />
